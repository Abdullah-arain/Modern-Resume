...
const PinContainer = ({ children, title, href, className, containerClassName, }) => {
    ...
    return (<link_1.default className={(0, cn_1.cn)("relative group/pin z-50  cursor-pointer", containerClassName)} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} href={href || "/"}>
      <div style={{
            perspective: "1000px",
...
const PinPerspective = ({ title, href, }) => {
    return (<framer_motion_1.motion.div className="pointer-events-none  w-full h-full flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
